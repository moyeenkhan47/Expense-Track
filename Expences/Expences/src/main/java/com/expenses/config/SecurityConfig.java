...
import com.expenses.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    private final CustomUserDetailService userDetailsService; // Automatically injected with RequiredArgsConstructor
